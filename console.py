#!/usr/bin/python3
"""
Defines the CustomConsole for the AirBnB project.
"""
...
class CustomConsole(cmd.Cmd):
    """
    Defines a custom command-line interpreter for the AirBnB project.
    """
    ...
    def do_create(self, arg):
        ...
        elif arg_list[0] not in CustomConsole.valid_classes:
    ...
    def do_all(self, arg):
        ...
        arg_list = parse_argument(arg)
        if len(arg_list) > 0 and arg_list[0] not in CustomConsole.valid_classes:
            print("** class doesn't exist **")
        else:
            obj_list = []
    ...
    def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        ...
        if len(arg_list) == 0:
            print("** class name missing **")
            return False
        if arg_list[0] not in CustomConsole.valid_classes:
            print("** class doesn't exist **")
            return False
        if len(arg_list) == 1:
            print("** instance id missing **")
